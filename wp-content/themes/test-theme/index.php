        ...
        <div class="carousel-wrap ">
          <div class="service_owl-carousel owl-carousel">
            <div class="item">
              <div class="box ">
                <div class="img-box">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/s1.png" alt="" />
                </div>
                <div class="detail-box">
                  <h5>
                    Home Welding
            ...
            <div class="item">
              <div class="box ">
                <div class="img-box">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/s4.png" alt="" />
                </div>
                <div class="detail-box">
                  <h5>
                    Machine Welding
            ...
            <div class="item">
              <div class="box ">
                <div class="img-box">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/s6.png" alt="" />
                </div>
                <div class="detail-box">
                  <h5>
                    Car Welding
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-6 px-0">
          <div class="img-box ">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/about-img.jpg" class="box_img" alt="about img">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/t1.jpg" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Martin Anderson
        ...
        <div class="col-md-4 col-sm-6 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/t2.jpg" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Denny Butler
        ...
        <div class="col-md-4 col-sm-6 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/t3.jpg" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Nathan Mcpherson
  ...
  <section class="contact_section ">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-6 px-0">
          <div class="img-box ">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/contact-img.jpg" class="box_img" alt="about img">
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-lg-7 col-md-9 mx-auto">
                <div class="client_container ">
                  <div class="img-box">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/client.jpg" alt="">
                  </div>
                  <div class="detail-box">
                    <h5>
                      Jone Mark
